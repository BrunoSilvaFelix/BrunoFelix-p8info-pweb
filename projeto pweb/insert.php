...
$stmt_prepared_okay =  mysqli_stmt_prepare($stmt, "INSERT INTO infobolo (nome, email, telefone, mensagem, tipobolo, status_pedido) VALUES (?, ?, ?, ?, ?, ?)");   

if ($stmt_prepared_okay) {

    mysqli_stmt_bind_param($stmt, "ssssss", $nome, $email, $telefone, $mensagem, $tipobolo, $status_pedido);    
